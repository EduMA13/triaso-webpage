...
const images = [
  "/Images/Carrusel_remolques/1.png",
  "/Images/Carrusel_remolques/2.png",
  "/Images/Carrusel_remolques/3.png",
  "/Images/Carrusel_remolques/4.png",
  "/Images/Carrusel_remolques/5.png",
]

const CarruselRemolques = () => {
...
export default CarruselRemolques